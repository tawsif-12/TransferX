...
function generateSQL() {
    ...
    playerProfiles.forEach((profile, index) => {
        ...
        sql += `INSERT INTO [User] (email, password, fullName, role) VALUES ('${email}', '$2a$10$dummy', '${profile.name}', 'PLAYER');\n`;
        sql += `GO\n`;
    });
    ...
    playerProfiles.forEach(profile => {
        ...
        console.log('✅ SQL statements written to insert-player-profiles.sql');
        ...
        async function executeSQL() {
            try {
                ...
                if (stdout) console.log('✅ Output:', stdout.substring(0, 1500));
                console.log('\n✅ PlayerProfile and User data inserted successfully!');
                ...
                console.log('Count Results:', profileOut);
                ...
                if (error.stdout) console.log('Stdout:', error.stdout.substring(0, 2000));
                if (error.stderr) console.log('Stderr:', error.stderr.substring(0, 2000));
            }
        }
